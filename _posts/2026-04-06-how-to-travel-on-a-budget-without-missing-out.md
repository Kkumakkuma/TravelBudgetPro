...
<div style="background: #eff6ff; border: 2px solid #3b82f6; border-radius: 12px; padding: 25px; margin: 30px 0; text-align: center;">
  <h3 style="color: #1e40af; margin-top: 0;">Get the Travel Budget Calculator</h3>
  <p style="color: #555; margin-bottom: 15px;">Track every travel expense in real time and never blow your budget again with this Notion template.</p>
  <a href="https://smarttemplatesell.gumroad.com/l/travel-budget" target="_blank" style="display: inline-block; background: #3b82f6; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold;">Get It Now - $5.99</a>
</div>
